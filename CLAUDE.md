...
- Live実機用（Ableton が実際に見る場所）:
  - `C:\Users\djhar\Documents\Ableton\User Library\Presets\MIDI Effects\Max MIDI Effect\` ← **主**
  - `D:\program files\ableton live song\User Library\Presets\MIDI Effects\Max MIDI Effect\`
